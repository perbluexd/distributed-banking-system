package com.banking.account.infrastructure.messaging.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CustomerCreatedEvent> customerCreatedConsumerFactory(
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.banking.account.infrastructure.messaging.event");
